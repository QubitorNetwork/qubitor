...
type Message struct {
	...
	// AllowContractSender permits Qubitor-native transactions to use a smart
	// account as the gas-paying sender after node-level PQ authorization.
...
func TransactionToMessage(tx *types.Transaction, s types.Signer, baseFee *big.Int) (*Message, error) {
	msg := &Message{
		...
		AllowContractSender: tx.Type() == types.QubitorPQTxType,
