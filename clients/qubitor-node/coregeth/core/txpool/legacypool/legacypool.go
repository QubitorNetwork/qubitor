...
// pool, specifically, whether it is a Legacy, AccessList, Dynamic, or Qubitor PQ transaction.
func (pool *LegacyPool) Filter(tx *types.Transaction) bool {
	switch tx.Type() {
	case types.LegacyTxType, types.AccessListTxType, types.DynamicFeeTxType, types.QubitorPQTxType:
		return true
	default:
		return false
	}
