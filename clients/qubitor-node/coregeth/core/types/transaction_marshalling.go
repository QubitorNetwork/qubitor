...
type txJSON struct {
	...
	FactorySalt          *common.Hash    `json:"factorySalt,omitempty"`
	PQPublicKey          *hexutil.Bytes  `json:"pqPublicKey,omitempty"`
	PQContext            *hexutil.Bytes  `json:"pqContext,omitempty"`
...
func (tx *Transaction) MarshalJSON() ([]byte, error) {
	...
	case *QubitorPQTx:
		...
		enc.Input = (*hexutil.Bytes)(&itx.Data)
		enc.AccessList = &itx.AccessList
		enc.Account = &itx.Account
		enc.FactorySalt = &itx.FactorySalt
		enc.PQPublicKey = (*hexutil.Bytes)(&itx.PQPublicKey)
		enc.PQContext = (*hexutil.Bytes)(&itx.PQContext)
		enc.PQSignature = (*hexutil.Bytes)(&itx.PQSignature)
		zero := new(big.Int)
		enc.V = (*hexutil.Big)(zero)
		enc.R = (*hexutil.Big)(zero)
		enc.S = (*hexutil.Big)(zero)
	}
...
func (tx *Transaction) UnmarshalJSON(input []byte) error {
	...
	case QubitorPQTxType:
		...
		if dec.Account == nil {
			return errors.New("missing required field 'account' in qubitor pq transaction")
		}
		itx.Account = *dec.Account
		if dec.FactorySalt != nil {
			itx.FactorySalt = *dec.FactorySalt
		}
		if dec.PQPublicKey == nil {
			return errors.New("missing required field 'pqPublicKey' in qubitor pq transaction")
		}
		itx.PQPublicKey = *dec.PQPublicKey
		if dec.PQContext != nil {
			itx.PQContext = *dec.PQContext
		}
		if dec.PQSignature == nil {
			return errors.New("missing required field 'pqSignature' in qubitor pq transaction")
		}
		itx.PQSignature = *dec.PQSignature
