...
func qubitorEOATransactionsDisabled() bool {
	return os.Getenv("QUBITOR_EOA_TXS") == "0"
}

func rejectDisabledLegacyEthereumTx(method string, txType uint8) error {
	if !qubitorEOATransactionsDisabled() || txType == types.QubitorPQTxType {
		return nil
	}
	return fmt.Errorf("%w: %s rejects legacy Ethereum transaction type %d while QUBITOR_EOA_TXS=0; submit QubitorPQTxType via qubitor_sendRawPQTransaction", types.ErrTxTypeNotSupported, method, txType)
}
...
func (s *PersonalAccountAPI) SendTransaction(ctx context.Context, args TransactionArgs, passwd string) (common.Hash, error) {
	if err := rejectDisabledLegacyEthereumTx("personal_sendTransaction", types.LegacyTxType); err != nil {
...
func (s *PersonalAccountAPI) SignTransaction(ctx context.Context, args TransactionArgs, passwd string) (*SignTransactionResult, error) {
	if err := rejectDisabledLegacyEthereumTx("personal_signTransaction", types.LegacyTxType); err != nil {
		return nil, err
	}
...
// QubitorTransactionAPI exposes Qubitor-native transaction submission helpers.
type QubitorTransactionAPI struct {
	b Backend
}

// NewQubitorTransactionAPI creates the Qubitor RPC transaction service.
func NewQubitorTransactionAPI(b Backend) *QubitorTransactionAPI {
	return &QubitorTransactionAPI{b: b}
}

// SendRawPQTransaction adds a signed QubitorPQTxV1 transaction to the pool.
func (s *QubitorTransactionAPI) SendRawPQTransaction(ctx context.Context, input hexutil.Bytes) (common.Hash, error) {
	tx := new(types.Transaction)
	if err := tx.UnmarshalBinary(input); err != nil {
		return common.Hash{}, err
	}
	if tx.Type() != types.QubitorPQTxType {
		return common.Hash{}, fmt.Errorf("%w: qubitor_sendRawPQTransaction requires QubitorPQTxType", types.ErrTxTypeNotSupported)
	}
...
func (s *TransactionAPI) SendTransaction(ctx context.Context, args TransactionArgs) (common.Hash, error) {
	if err := rejectDisabledLegacyEthereumTx("eth_sendTransaction", types.LegacyTxType); err != nil {
		return common.Hash{}, err
	}
	// Look up the wallet containing the requested signer
	account := accounts.Account{Address: args.from()}
...
func (s *TransactionAPI) FillTransaction(ctx context.Context, args TransactionArgs) (*SignTransactionResult, error) {
	if err := rejectDisabledLegacyEthereumTx("eth_fillTransaction", types.LegacyTxType); err != nil {
		return nil, err
	}
...
func (s *TransactionAPI) SendRawTransaction(ctx context.Context, input hexutil.Bytes) (common.Hash, error) {
	...
	if err := rejectDisabledLegacyEthereumTx("eth_sendRawTransaction", tx.Type()); err != nil {
		return common.Hash{}, err
	}
	return SubmitTransaction(ctx, s.b, tx)
}
...
func (s *TransactionAPI) SignTransaction(ctx context.Context, args TransactionArgs) (*SignTransactionResult, error) {
	if err := rejectDisabledLegacyEthereumTx("eth_signTransaction", types.LegacyTxType); err != nil {
		return nil, err
	}
	if args.Gas == nil {
		return nil, errors.New("gas not specified")
