...
PUBLIC_BRIDGE_API_URL="${QUBITOR_PUBLIC_BRIDGE_API_URL:-https://api.0xq.app}"
...
PUBLIC_BRIDGE_API_ALIASES="${QUBITOR_PUBLIC_BRIDGE_API_ALIASES:-}"
BRIDGE_BACKEND_NETWORK="${QUBITOR_BRIDGE_BACKEND_NETWORK:-qubitor-bridge-testnet_default}"
...
QUBITOR_PUBLIC_BRIDGE_API_URL=$PUBLIC_BRIDGE_API_URL
...
QUBITOR_PUBLIC_BRIDGE_API_ALIASES=$PUBLIC_BRIDGE_API_ALIASES
QUBITOR_BRIDGE_BACKEND_NETWORK=$BRIDGE_BACKEND_NETWORK
