...
require_contains "$PACKAGE_JSON" "\"testnet:peer-repair:status\""
...
require_contains "$TESTNET_SERVER_ACCESS_LIB" "--exclude .env.testnet"
require_contains "$TESTNET_SERVER_ACCESS_LIB" "--exclude data"
require_contains "$TESTNET_PEER_DIVERSITY" "QUBITOR_PEER_DIVERSITY_RPC_URLS"
...
require_contains "$TESTNET_PEER_GUARD" "miner_start"
...
require_contains "$ENV_TESTNET" "QUBITOR_PEER_GUARD_INTERVAL_MS="
...
require_contains "$TESTNET_READINESS" "pnpm testnet:peer-guard:install"
...
require_contains "$TESTNET_LAUNCH_MATERIAL" "peer-guard"
