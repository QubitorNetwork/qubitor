...
TESTNET_BREAK_GLASS_RESET="$ROOT_DIR/docs/testnet/break-glass-reset.md"
...
TESTNET_SECONDARY_RPC="$ROOT_DIR/scripts/testnet/secondary-rpc.sh"
TESTNET_SERVER_ACCESS_LIB="$ROOT_DIR/scripts/testnet/server-access-lib.sh"
TESTNET_LOCAL_SNAPSHOT="$ROOT_DIR/scripts/testnet/local-snapshot.sh"
TESTNET_SNAPSHOT="$ROOT_DIR/scripts/testnet/snapshot.sh"
TESTNET_HEIGHT_MONITOR="$ROOT_DIR/scripts/testnet/height-monitor.sh"
TESTNET_HEIGHT_MONITOR_REMOTE="$ROOT_DIR/scripts/testnet/height-monitor-remote.sh"
TESTNET_PEER_DIVERSITY="$ROOT_DIR/scripts/testnet/peer-miner-diversity.mjs"
TESTNET_PEER_REPAIR="$ROOT_DIR/scripts/testnet/peer-repair.sh"
TESTNET_PEER_GUARD="$ROOT_DIR/scripts/testnet/peer-guard.mjs"
TESTNET_AUX_MINER="$ROOT_DIR/scripts/testnet/aux-miner.sh"
TESTNET_DEPLOY_SAFETY="$ROOT_DIR/scripts/testnet/deploy-safety.sh"
TESTNET_SYNC_OPS_CODE="$ROOT_DIR/scripts/testnet/sync-ops-code.sh"
TESTNET_BRIDGE_GENESIS_VERIFY="$ROOT_DIR/scripts/testnet/verify-bridge-genesis.mjs"
MAINNET_READINESS_DASHBOARD="$ROOT_DIR/scripts/mainnet/readiness-dashboard.mjs"
TESTNET_PUBLIC_SURFACE_DOC="$ROOT_DIR/docs/testnet/firewall-and-public-surface.md"
COMPOSE_AUX_MINER="$ROOT_DIR/infra/docker-compose.aux-miner.yml"
...
for file in \
  ...
  "$TESTNET_SECONDARY_RPC" \
  "$TESTNET_SERVER_ACCESS_LIB" \
  "$TESTNET_LOCAL_SNAPSHOT" \
  "$TESTNET_SNAPSHOT" \
  "$TESTNET_HEIGHT_MONITOR" \
  "$TESTNET_HEIGHT_MONITOR_REMOTE" \
  "$TESTNET_PEER_DIVERSITY" \
  "$TESTNET_PEER_REPAIR" \
  "$TESTNET_PEER_GUARD" \
  "$TESTNET_AUX_MINER" \
  "$TESTNET_DEPLOY_SAFETY" \
  "$TESTNET_SYNC_OPS_CODE" \
  "$TESTNET_BRIDGE_GENESIS_VERIFY" \
  "$MAINNET_READINESS_DASHBOARD" \
  "$TESTNET_PUBLIC_SURFACE_DOC" \
  "$COMPOSE_AUX_MINER" \
  "$TESTNET_GENESIS" \
  "$TESTNET_BOOTNODES" \
...
require_contains "$PACKAGE_JSON" "\"testnet:secondary-rpc:deploy\""
require_contains "$PACKAGE_JSON" "\"testnet:secondary-rpc:status\""
require_contains "$PACKAGE_JSON" "\"testnet:secondary-rpc:logs\""
require_contains "$PACKAGE_JSON" "\"testnet:secondary-rpc:restart\""
require_contains "$PACKAGE_JSON" "\"testnet:deploy-safety\""
require_contains "$PACKAGE_JSON" "\"testnet:snapshot:run\""
require_contains "$PACKAGE_JSON" "\"testnet:snapshot:install-cron\""
require_contains "$PACKAGE_JSON" "\"testnet:height-monitor:run\""
require_contains "$PACKAGE_JSON" "\"testnet:height-monitor:install-cron\""
require_contains "$PACKAGE_JSON" "\"testnet:peer-diversity:check\""
require_contains "$PACKAGE_JSON" "\"testnet:peer-repair\""
require_contains "$PACKAGE_JSON" "\"testnet:peer-guard:install\""
require_contains "$PACKAGE_JSON" "\"testnet:aux-miner:deploy\""
require_contains "$PACKAGE_JSON" "\"testnet:aux-miner:status\""
require_contains "$PACKAGE_JSON" "\"testnet:ops-code:deploy\""
require_contains "$PACKAGE_JSON" "\"testnet:ops-code:restart-rpc\""
require_contains "$PACKAGE_JSON" "\"testnet:ops-code:deploy-rpc-hardening\""
require_contains "$PACKAGE_JSON" "\"mainnet:readiness-dashboard\""
...
require_contains "$CHAIN_CONFIG" "QUBITOR_TESTNET_SECONDARY_RPC_URL"
require_contains "$CHAIN_CONFIG" "https://testrpc2.qubitor.org/rpc"
...
require_contains "$COMPOSE" "QUBITOR_REQUIRED_PEERS: \${QUBITOR_REQUIRED_PEERS:-}"
require_contains "$COMPOSE" "QUBITOR_MIN_PEERS_BEFORE_MINE: \${QUBITOR_MIN_PEERS_BEFORE_MINE:-1}"
require_contains "$COMPOSE" "peer-guard"
require_contains "$COMPOSE" "scripts/testnet/peer-guard.mjs"
...
require_contains "$TESTNET_BOOTNODES" "\"genesisHash\": \"0x8c422f1572daf17ff4b699c98db0b1d72a71bf9ef0f8cb926b1a15b4a3f33483\""
require_contains "$TESTNET_BOOTNODES" "\"bootnodeCount\": 2"
require_contains "$TESTNET_BOOTNODES" "enode://39214e35a86ef628de4c359aa5778c9baa0c053f95886d215d8f51d4f17151a02af63f187fce06083fe5e0b151a9e3a2accc71d1312d72d2a989facf66e5012c@bootnode-1.testnet.qubitor.org:30303"
require_contains "$TESTNET_BOOTNODES" "enode://59b33be8ed0165c35f508971e7d08c84168d1d8f8e9927bf332c19b4b0d0275ee758c883b035a2271395c7cf968a582f6e59f407fcaa1c6b7ee84001d96b4a10@bootnode-2.testnet.qubitor.org:30303"
require_contains "$TESTNET_BOOTNODES" "\"fallbackBootnodes\""
require_contains "$TESTNET_BOOTNODES" "enode://39214e35a86ef628de4c359aa5778c9baa0c053f95886d215d8f51d4f17151a02af63f187fce06083fe5e0b151a9e3a2accc71d1312d72d2a989facf66e5012c@66.29.136.165:30303"
require_contains "$TESTNET_BOOTNODES" "enode://59b33be8ed0165c35f508971e7d08c84168d1d8f8e9927bf332c19b4b0d0275ee758c883b035a2271395c7cf968a582f6e59f407fcaa1c6b7ee84001d96b4a10@66.29.128.164:30303"
...
require_contains "$TESTNET_RESET_WITH_BRIDGE_GENESIS" "QUBITOR_TESTNET_RESET_CONFIRM"
require_contains "$TESTNET_RESET_WITH_BRIDGE_GENESIS" "RESET_QUBITOR_TESTNET_91338"
require_contains "$TESTNET_RESET_WITH_BRIDGE_GENESIS" "backup_testnet_state"
require_contains "$TESTNET_RESET_WITH_BRIDGE_GENESIS" "backups/testnet-reset"
require_contains "$TESTNET_RESET_WITH_BRIDGE_GENESIS" "preResetHead"
require_contains "$TESTNET_RESET_WITH_BRIDGE_GENESIS" "rm -rf data/node/testnet data/indexer/testnet"
require_contains "$TESTNET_SECONDARY_RPC" "testrpc2.qubitor.org"
require_contains "$TESTNET_SECONDARY_RPC" "testexplorer2.qubitor.org"
require_contains "$TESTNET_SECONDARY_RPC" "node-env/bootnode-2.env"
require_contains "$TESTNET_SECONDARY_RPC" "--profile all up -d --build"
require_contains "$TESTNET_SECONDARY_RPC" "QUBITOR_PUBLIC_RPC_URL"
reject_contains "$TESTNET_SECONDARY_RPC" "rm -rf data/node/testnet"
reject_contains "$TESTNET_SECONDARY_RPC" "DISCORD_VERIFY"
require_contains "$TESTNET_DEPLOY_SAFETY" "public deploy paths do not reset testnet chain data"
require_contains "$TESTNET_DEPLOY_SAFETY" "rm -rf data/node/testnet"
require_contains "$TESTNET_LOCAL_SNAPSHOT" "bridge-postgres.sql.gz"
require_contains "$TESTNET_LOCAL_SNAPSHOT" "qubitor-chain-export.rlp.gz"
require_contains "$TESTNET_SNAPSHOT" "/etc/cron.d/qubitor-testnet-snapshot"
require_contains "$TESTNET_HEIGHT_MONITOR" "HEIGHT_DROPPED"
require_contains "$TESTNET_HEIGHT_MONITOR" "GENESIS_CHANGED"
require_contains "$TESTNET_HEIGHT_MONITOR_REMOTE" "/etc/cron.d/qubitor-testnet-height-monitor"
require_contains "$TESTNET_PEER_DIVERSITY" "QUBITOR_MIN_PUBLIC_PEERS"
require_contains "$TESTNET_PEER_DIVERSITY" "QUBITOR_MIN_RECENT_MINERS"
require_contains "$TESTNET_PEER_DIVERSITY" "QUBITOR_PUBLIC_RPC_HASH_SAMPLE_DEPTH"
require_contains "$TESTNET_PEER_DIVERSITY" "public RPC block hash divergence"
require_contains "$TESTNET_PEER_DIVERSITY" "eth_getBlockByNumber"
require_contains "$TESTNET_PEER_REPAIR" "never runs geth init"
require_contains "$TESTNET_PEER_REPAIR" "miner_stop"
require_contains "$TESTNET_PEER_REPAIR" "admin_addPeer"
require_contains "$TESTNET_PEER_REPAIR" "admin_addTrustedPeer"
require_contains "$TESTNET_PEER_GUARD" "QUBITOR_MIN_PEERS_BEFORE_MINE"
require_contains "$TESTNET_PEER_GUARD" "miner_stop"
require_contains "$TESTNET_PEER_GUARD" "admin_addPeer"
require_contains "$TESTNET_AUX_MINER" "testnet-aux-miner-"
require_contains "$TESTNET_AUX_MINER" "QUBITOR_AUX_MINER_ETHERBASE"
require_contains "$TESTNET_AUX_MINER" "rsync_repo_to_target"
require_contains "$COMPOSE_AUX_MINER" "QUBITOR_AUX_MINER_ALLOW_INIT"
require_contains "$COMPOSE_AUX_MINER" "QUBITOR_AUX_MINER_DATA_LABEL"
require_contains "$COMPOSE_AUX_MINER" "QUBITOR_AUX_MINER_START_MINING"
require_contains "$COMPOSE_AUX_MINER" "QUBITOR_REQUIRED_PEERS"
require_contains "$COMPOSE_AUX_MINER" "testnet-aux-miner-*"
reject_contains "$COMPOSE_AUX_MINER" "data/node/testnet:/data"
require_contains "$MAINNET_READINESS_DASHBOARD" "External audit closure is deferred until the report or attestation is added"
require_contains "$MAINNET_READINESS_DASHBOARD" "peer-miner-diversity.mjs"
require_contains "$TESTNET_SYNC_OPS_CODE" "restart-explorer"
require_contains "$TESTNET_SERVER_ACCESS_LIB" "rsync_repo_to_target"
...
require_contains "$ENV_TESTNET" "QUBITOR_REQUIRED_PEERS="
require_contains "$ENV_TESTNET" "QUBITOR_MIN_PEERS_BEFORE_MINE=1"
require_contains "$ENV_TESTNET" "QUBITOR_PEER_GUARD_PUBLIC_RPC_URLS="
require_contains "$ENV_TESTNET" "QUBITOR_AUX_MINER_START_MINING=0"
...
reject_contains "$TESTNET_READINESS" "testnet:reset-with-bridge-genesis"
reject_contains "$TESTNET_READINESS" "QUBITOR_TESTNET_RESET_CONFIRM"
require_contains "$TESTNET_READINESS" "pnpm testnet:secondary-rpc:deploy"
require_contains "$TESTNET_READINESS" "pnpm testnet:ops-code:deploy-rpc-hardening"
require_contains "$TESTNET_READINESS" "pnpm testnet:peer-diversity:check"
require_contains "$TESTNET_READINESS" "pnpm testnet:aux-miner:deploy"
require_contains "$TESTNET_READINESS" "data/node/testnet-aux-miner-*"
require_contains "$TESTNET_READINESS" "docs/testnet/firewall-and-public-surface.md"
require_contains "$TESTNET_READINESS" "docs/testnet/break-glass-reset.md"
require_contains "$TESTNET_READINESS" "https://testrpc2.qubitor.org/rpc"
...
require_contains "$TESTNET_BREAK_GLASS_RESET" "not part of normal testnet operations"
require_contains "$TESTNET_BREAK_GLASS_RESET" "Do not reset the chain"
require_contains "$TESTNET_BREAK_GLASS_RESET" "pnpm testnet:ops-code:deploy-rpc-hardening"
require_contains "$TESTNET_PUBLIC_SURFACE_DOC" "Raw CoreGeth HTTP RPC must stay bound to loopback"
require_contains "$TESTNET_PUBLIC_SURFACE_DOC" "admin_*"
require_contains "$TESTNET_PUBLIC_SURFACE_DOC" "Metrics, database ports, Redis"
...
require_contains "$TESTNET_LAUNCH_MATERIAL" "testrpc2.qubitor.org"
require_contains "$TESTNET_LAUNCH_MATERIAL" "pnpm testnet:secondary-rpc:deploy"
require_contains "$TESTNET_LAUNCH_MATERIAL" "QUBITOR_TESTNET_RESET_CONFIRM=RESET_QUBITOR_TESTNET_91338"
require_contains "$TESTNET_LAUNCH_MATERIAL" "backups/testnet-reset"
